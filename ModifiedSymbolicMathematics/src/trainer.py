...
class Trainer(object):
    ...
    def __init__(self, modules, env, params):
        ...
        if params.reload_data != '':
            ...
            # print("self.data_path.values()", self.data_path.values())
            # print("list(self.data_path.values())[0][0]", list(self.data_path.values())[0][0])
            # print("os.path.isfile(list(self.data_path.values())[0][0])", os.path.isfile(list(self.data_path.values())[0][0]))
            # print("os.path.isfile(list(self.data_path.values())[0][1])", os.path.isfile(list(self.data_path.values())[0][1]))
            # print("os.path.isfile(list(self.data_path.values())[0][2])", os.path.isfile(list(self.data_path.values())[0][2]))
            # print("all(all(os.path.isfile(path) for path in paths) for paths in self.data_path.values())", all(all(os.path.isfile(path) for path in paths) for paths in self.data_path.values()))
